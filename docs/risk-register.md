...
| R-005 | Non-loopback Voicebox URL sends private media off-device. | Low | High | Default to `127.0.0.1`, warn and require explicit confirmation for remote URLs, update DPIA before release. | Product | Monitoring |
